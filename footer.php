<footer id="FOOTER" class="footer section_wrap">
    <div class="main main_flex">
        <div class="left">
            <h3><a href="<?php echo esc_url(home_url('//')); ?>"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png"></a></h3>
    ...
    <div class="bottom">© JCAS Airways Co, Ltd</div>
</footer>
</div>
<?php wp_footer(); ?>
</body>
