...
<div class="wrapper">
    ...
    <header id="TOP-HEADER" class="top-header">
        <h1><a href="<?php echo esc_url(home_url('//')); ?>" class="left-logo"><img src="<?php echo get_template_directory_uri(); ?>/assets/img/logo.png" alt="JCAS Airways"></a></h1>
        <ul class="right-buttons">
            <li><a href="<?php echo esc_url(home_url('//')); ?>">私たちについて</a></li>
            <li><a href="<?php echo esc_url(home_url('//')); ?>">地域連携</a></li>
            <li><a href="<?php echo esc_url(home_url('//')); ?>">会社概要</a></li>
            <li><a href="<?php echo esc_url(home_url('//')); ?>">ニュース</a></li>
            <li><a href="<?php echo esc_url(home_url('//')); ?>">事業紹介</a></li>
